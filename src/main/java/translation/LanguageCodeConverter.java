...
public class LanguageCodeConverter {
        ...
        try {
            ...
            while (iterator.hasNext()) {
                ...
                if (parts.length >= 2) {
                    ...
                    String code     = parts[1].trim().toLowerCase(); // normalize to lowercase
    ...
    public String fromLanguageCode(String code) {
        if (code == null) return null; // optional null check
    ...
    public String fromLanguage(String language) {
        if (language == null) return null; // optional null check
